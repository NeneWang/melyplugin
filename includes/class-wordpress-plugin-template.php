...
class WordPress_Plugin_Template {
	...
	public function load_localisation() {
		load_plugin_textdomain( 'mely-plugin', false, dirname( plugin_basename( $this->file ) ) . '/lang/' );
	...
	public function __clone() {
		_doing_it_wrong( __FUNCTION__, esc_html__( 'Cloning of WordPress_Plugin_Template is forbidden', 'mely-plugin'  ), esc_attr( $this->_version ) );
	...
	public function __wakeup() {
		_doing_it_wrong( __FUNCTION__, esc_html__( 'Unserializing instances of WordPress_Plugin_Template is forbidden', 'mely-plugin'  ), esc_attr( $this->_version ) );
	} // End __wakeup ()
